...
public class RwmActivity extends AppCompatActivity{
    ...
    private static final int BARCODE_READER_ACTIVITY_REQUEST_BT_2 = 1209;
    private static final int BARCODE_READER_ACTIVITY_REQUEST_BT_3 = 1210;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ivSpeaker = findViewById(R.id.imageSpechToText);
...
// endregion ModeleSpinner
        ...
        ivSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (launchIntent.resolveActivity(getPackageManager()) != null) {
                    startActivityForResult(launchIntent, BARCODE_READER_ACTIVITY_REQUEST_BT_3);
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BARCODE_READER_ACTIVITY_REQUEST_BT_3 && data != null ) {
            ArrayList<String> result = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
            etBemerkungen.setText(! etBemerkungen.getText().equals("") ? etBemerkungen.getText() + "\n" + result.get(0): result.get(0));
        }
