...
import de.eneko.nekomobile.activities.adapter.DropboxFilesAdapter;
import de.eneko.nekomobile.framework.dropbox.DownloadFileTask;
import de.eneko.nekomobile.framework.dropbox.DropboxClientFactory;
import de.eneko.nekomobile.framework.dropbox.ListFolderTask;
import de.eneko.nekomobile.framework.dropbox.NekoDropBox;
import de.eneko.nekomobile.framework.dropbox.PicassoClient;
import de.eneko.nekomobile.framework.dropbox.UploadFileTask;
...
public class DropboxFilesActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_PATH = "DropboxFilesActivityStartPath";
    ...
    public static Intent getIntent(Context context, String path) {
        Intent filesIntent = new Intent(context, DropboxFilesActivity.class);
        filesIntent.putExtra(DropboxFilesActivity.EXTRA_PATH, path);
        return filesIntent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilesAdapter = new DropboxFilesAdapter(PicassoClient.getPicasso(), new DropboxFilesAdapter.Callback() {
            @Override
            public void onFolderClicked(FolderMetadata folder) {
                startActivity(DropboxFilesActivity.getIntent(DropboxFilesActivity.this, folder.getPathLower()));
            }
            @Override
    ...
    protected void loadData() {
        ...
        new ListFolderTask(DropboxClientFactory.getClient(), mPath, new ListFolderTask.Callback() {
            @Override
            ...
            public void onError(Exception e) {
                ...
                Toast.makeText(DropboxFilesActivity.this,
    ...
    private void downloadFile(FileMetadata file) {
        ...
        String targetPathString = GlobalConst.PATH_NEKOMOBILE;
        if (mSelectedFile.toString().endsWith(".neko.xml")) targetPathString = GlobalConst.PATH_NEKOMOBILE;
        if (mSelectedFile.toString().endsWith(".droid.xml")) targetPathString = GlobalConst.PATH_EXIM;
        if (mSelectedFile.toString().endsWith(".son.xml")) targetPathString = GlobalConst.PATH_SONTEX;

        File targetDir = new File(targetPathString);

        new DownloadFileTask(DropboxFilesActivity.this, DropboxClientFactory.getClient(), targetDir , new DownloadFileTask.Callback() {
            @Override
    ...
    private void uploadFile(String fileUri) {
        ...
        new UploadFileTask(this, DropboxClientFactory.getClient(), new UploadFileTask.Callback() {
            ...
            public void onUploadComplete(FileMetadata result) {
                ...
                Toast.makeText(DropboxFilesActivity.this, message, Toast.LENGTH_SHORT)
                        .show();
